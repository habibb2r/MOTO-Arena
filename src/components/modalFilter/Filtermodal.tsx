...
export function FilterModal({ open, setOpen, handleFillter, handleFillterFailed, categories = [], brands = [] }: FilterModalProps) {
        ...
        <div className="grid grid-cols-2 gap-2 place-items-center text-black">
          <div className="w-full">
            ...
            >
              ...
              <InputNumber placeholder="max price" style={{ width: "100%", borderColor: "blue", color: "black" }} />
            </Form.Item>
          </div>
          <div className="w-full">
            ...
            >
              ...
              <InputNumber placeholder="min price" style={{ width: "100%", borderColor: "blue", color: "black"}} />
            </Form.Item>
          </div>
          ...
          <div className="w-full ">
            ...
            >
              ...
              <Select loading={!!!categories} placeholder="Select a Category" >
                {categories ? categories.map((category, idx) => (<Select.Option key={idx} value={category?.value}>{category?.name}</Select.Option>)) : (<Select.Option value="">No model</Select.Option>)}
              </Select>
            </Form.Item>
          </div>
